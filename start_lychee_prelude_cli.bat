...
set "PYTHONUTF8=1"
set "LONG_NOVEL_PROJECT_TAG=lychee_prelude"
set "LONG_NOVEL_USER_AGENT=Long-Novel-GPT/lychee_prelude"
set "PROJECT_DIR=%~dp0auto_projects\lychee_prelude"
...
"%PYTHON_CMD%" watch_auto_novel_visible.py ^
  ...
  --min-target-chars 500000 ^
  --force-finish-chars 1000000 ^
  --max-target-chars 1200000 ^
  --chapter-char-target 2200 ^
  --chapters-per-volume 25 ^
