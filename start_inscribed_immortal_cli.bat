...
set "PYTHONUTF8=1"
set "LONG_NOVEL_PROJECT_TAG=inscribed_immortal"
set "LONG_NOVEL_USER_AGENT=Long-Novel-GPT/inscribed_immortal"
set "PROJECT_DIR=%~dp0auto_projects\inscribed_immortal"
