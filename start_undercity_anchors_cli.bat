...
set "PYTHONUTF8=1"
set "LONG_NOVEL_PROJECT_TAG=undercity_anchors"
set "LONG_NOVEL_USER_AGENT=Long-Novel-GPT/undercity_anchors"
set "PROJECT_DIR=%~dp0auto_projects\undercity_anchors"
